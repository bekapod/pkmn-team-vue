<template>
  <svg viewBox="0 0 112 112" version="1.1">
    <g
      stroke="none"
      stroke-width="1"
      fill="none"
    ...
    >
      <path
        ...
        class="fill-white stroke-cool-grey-900 stroke-5"
        fill-rule="nonzero"
      />
      <path
        ...
        class="fill-red-vivid-500 stroke-cool-grey-900 stroke-5"
      ...
      />
      <circle class="fill-white" cx="12" cy="41" r="2" />
      <circle class="fill-cool-grey-900" cx="54.5" cy="54.5" r="9.5" />
    </g>
  </svg>
</template>
