        ...
        <div v-if="action" class="mt-4">
          <div class="-mx-2 -my-1.5 flex">
            <button
              ...
              :class="{
                'bg-red-vivid-50 text-red-vivid-800 hover:bg-red-vivid-100  focus:ring-red-vivid-600 focus:ring-offset-red-vivid-50':
                  type === 'error',
                'bg-green-vivid-50 text-green-vivid-800 hover:bg-green-vivid-100  focus:ring-green-vivid-600 focus:ring-offset-green-vivid-50':
                  type === 'success',
              }"
